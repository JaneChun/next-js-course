...
async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect('mongodb+srv://janechun22:janechun22@cluster0.jrwnfs4.mongodb.net/?retryWrites=true&w=majority');
    const db = client.db();
